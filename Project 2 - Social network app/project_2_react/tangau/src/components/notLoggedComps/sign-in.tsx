...
export default function SignInSide() {
    ...
    let axiosFetcher = async (eve: SyntheticEvent) => {
      ...
      const axiosUserPayLoad: any = await axios.post('http://localhost:8080/RevatureSocialNetwork/api/user/login', {
          "username": usernameState,
          "password": passwordState
      });
      
      const axiosPostPayLoad: any = await axios.get(`http://localhost:8080/RevatureSocialNetwork/api/post/get-posts/${usernameState}`);
