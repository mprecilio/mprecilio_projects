...
public class SignUp {
	...
	public static Accounts signUp() {
		...
		if (accType.equals("1") || (accType.toLowerCase()).equals("resaurant")) return new Restaurant(user,pass);
		else if (accType.equals("2") || (accType.toLowerCase()).equals("health inspector")) return new HealthInspector(user,pass);
		return null;
	}
